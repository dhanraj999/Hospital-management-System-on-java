...
PreparedStatement pst=null;
 ...
 private void Get_Data1(){
      try{
        ...
        String sql="select PatientID as 'Patient ID', PatientName as 'Patient Name' "
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
     try{
      con=DbConnection.ConnectDB();
       ...
       String sql= "insert into Services(ServiceName,ServiceDate,PatientID,ServiceCharges)"
               + "values('"+ txtServiceName.getText() + "','"+ txtServiceDate.getText() + "','" + txtPatientID.getText() + "',"
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
      ...
      con=DbConnection.ConnectDB();
       ...
       String sql= "update Services "
               + "set Servicename='"+ txtServiceName.getText() + "',ServiceDate='"+ txtServiceDate.getText() + "',"
               + "PatientID='" + txtPatientID.getText() + "',ServiceCharges=" + txtServiceCharges.getText() + " "
               + "where ServiceID=" + txtServiceID.getText() + "";
       pst=con.prepareStatement(sql);
       pst.execute();
