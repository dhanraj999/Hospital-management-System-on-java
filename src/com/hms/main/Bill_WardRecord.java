...
PreparedStatement pst=null;
 ...
 private void Get_Data(){
         try{
     String sql="Select BillNo as 'Bill No',DisChargePatient_Ward.ID as 'Discharge ID', AdmitPatient_Ward.AdmitID as 'Admit ID',"
     ...
     + "Ward.WardName as 'Ward Name',Doctor.DoctorID as 'Doctor ID',DoctorName as 'Doctor Name',"
             + "DischargeDate as 'Discharge Date',Bill_Ward.BedCharges as 'Bed Charges',Bill_Ward.ServiceCharges as 'Service Charges'"
             + ",Bill_Ward.BillingDate as 'Billing Date',PaymentMode as 'Payement Mode',PaymentModeDetails as 'Payment Mode Details',"
             + "TotalCharges as 'Total Charges',ChargesPaid as 'Charges Paid',DueCharges as 'Due Charges',NoOfDays as 'No Of Days',"
             + "TotalBedCharges as 'Total Bed Charges' "
             + "from Ward,Doctor,PatientRegistration,AdmitPatient_Ward,DischargePatient_Ward,Bill_Ward "
             + "where Ward.WardName=AdmitPatient_Ward.WardName and"
             + " Doctor.DoctorID=AdmitPatient_Ward.DoctorID and "
             + "PatientRegistration.PatientID=AdmitPatient_Ward.PatientID  and "
             + "AdmitPatient_Ward.admitID= DischargePatient_Ward.admitID and "
             + "Bill_Ward.DischargeID=DischargePatient_Ward.ID  "
